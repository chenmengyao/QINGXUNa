    ...
    <div>
      <el-row class="titleBackground">
        ...
        <el-col :span="8" style="text-align:right" v-if="buttonDis">
          <el-button size="mini" @click="onKaoQin(2)">考勤</el-button>
          <el-button size="mini" type="primary" @click="onKaoQin(1)">缺勤</el-button>
      ...
      <el-row style="margin-top:10px">
        <el-col :span="24">
          ...
          <!-- <el-table-column label="操作">
            <template slot-scope="scope">
              <span size="mini" style="color:#2d64b3" @click="onKaoQin(2)">考勤</span>&nbsp;
              <span size="mini" type="primary" style="color:red;" @click="onKaoQin(1)">缺勤</span>
            </template>
          </el-table-column> -->
          </el-table>
...
export default {
  ...
  methods: {
    ...
    fetchKaoQin (type) {
      ...
      this.doKaoQin(this.selectList).then(res => {
        const { code } = res
        if (code === 200) {
          this.searchForm.pageNum = 1
          this.fetchList()
